	...
	function WindowFunctions:TabGroup()
		...
		function SectionFunctions:Tab(Settings)
			...
			local function updateLayout()
				...
				contentColumnLeft.Size = isWide and UDim2.new(0.5, -5, 0, 0) or UDim2.new(1, 0, 0, 0)
				contentColumnRight.Visible = isWide

				for _, sec in ipairs(rightSections) do
					sec.Parent = isWide and contentColumnRight or contentColumnLeft
				end
			end
