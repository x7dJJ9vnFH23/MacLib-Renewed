...
do
	...
	function WMacLib:ResolveImage(path)
		if not path then return "" end
		if path:match("^%d+$") then
			return "rbxassetid://" .. path
		end
		if path:find("/") and not path:find("rbxassetid") then
...
local themes = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Wicikk/WMacLib/main/Misc/Themes.lua"))()
for _, theme in pairs(themes) do
	WMacLib:AddTheme(theme)
end
	...
	function WindowFunctions:TabGroup()
		...
		function SectionFunctions:Tab(Settings)
			...
			if Settings.Image then
				...
				tabImage.Image = WMacLib:ResolveImage(Settings.Image)
