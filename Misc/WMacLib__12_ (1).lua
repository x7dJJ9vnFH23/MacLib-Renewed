...
function WMacLib:Demo()
	...
	sections.MainSection2:Image({
		Header = "Demo Image",
		Image = getcustomasset and getcustomasset("https://raw.githubusercontent.com/Wicikk/WMacLib/main/Misc/Demo.png") or "https://raw.githubusercontent.com/Wicikk/WMacLib/main/Misc/Demo.png",
		Height = 120,
