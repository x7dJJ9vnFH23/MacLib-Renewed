...
function WMacLib:Window(Settings)
	shared.__WMacLibHubCount = (shared.__WMacLibHubCount or 0) + 1
	local isHub = shared.__WMacLibHubCount > 1

	if isHub and shared.__WMacLibWindow then
		local existingWindow = shared.__WMacLibWindow
		existingWindow.__pendingDivider = true
	...
	function WindowFunctions:TabGroup()
		...
		if WindowFunctions.__pendingDivider then
			WindowFunctions.__pendingDivider = false
			tabIndex += 1
			local autoDiv = Instance.new("Frame")
			autoDiv.Name = "TabDivider"
			autoDiv.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			autoDiv.BackgroundTransparency = 1
			autoDiv.BorderColor3 = Color3.fromRGB(0, 0, 0)
			autoDiv.BorderSizePixel = 0
			autoDiv.Size = UDim2.new(1, -21, 0, 17)
			autoDiv.LayoutOrder = tabIndex
			autoDiv.AnchorPoint = Vector2.new(0.5, 0)
			autoDiv.Position = UDim2.fromScale(0.5, 0)
			local autoDivLine = Instance.new("Frame")
			autoDivLine.Name = "Line"
			autoDivLine.AnchorPoint = Vector2.new(0.5, 0.5)
			autoDivLine.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			autoDivLine.BackgroundTransparency = 0.85
			autoDivLine.BorderColor3 = Color3.fromRGB(0, 0, 0)
			autoDivLine.BorderSizePixel = 0
			autoDivLine.Position = UDim2.fromScale(0.5, 0.5)
			autoDivLine.Size = UDim2.new(1, 0, 0, 1)
			autoDivLine.Parent = autoDiv
			autoDiv.Parent = sectionTabSwitchers
		end
		...
		function SectionFunctions:Tab(Settings)
			...
			function TabFunctions:Section(Settings)
				...
				function SectionFunctions:Progressbar(Settings, Flag)
					local ProgressbarFunctions = { Settings = Settings }
					local currentValue = math.clamp(Settings.Default or Settings.Value or 0, 0, 100)
					local currentColor = Settings.Color or Color3.fromRGB(73, 230, 133)
					...
					pbFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbFrame.BorderSizePixel = 0
					pbFrame.Size = UDim2.fromScale(1, 0)
					pbFrame.Parent = section

					local pbUIListLayout = Instance.new("UIListLayout")
					pbUIListLayout.Name = "ProgressbarUIListLayout"
					pbUIListLayout.Padding = UDim.new(0, 6)
					pbUIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
					pbUIListLayout.Parent = pbFrame

					local pbHeaderRow = Instance.new("Frame")
					pbHeaderRow.Name = "ProgressbarHeaderRow"
					pbHeaderRow.AutomaticSize = Enum.AutomaticSize.Y
					pbHeaderRow.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
					pbHeaderRow.BackgroundTransparency = 1
					pbHeaderRow.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbHeaderRow.BorderSizePixel = 0
					pbHeaderRow.Size = UDim2.fromScale(1, 0)
					pbHeaderRow.Parent = pbFrame

					local pbHeaderRowLayout = Instance.new("UIListLayout")
					pbHeaderRowLayout.Name = "ProgressbarHeaderRowLayout"
					pbHeaderRowLayout.FillDirection = Enum.FillDirection.Horizontal
					pbHeaderRowLayout.HorizontalAlignment = Enum.HorizontalAlignment.Left
					pbHeaderRowLayout.SortOrder = Enum.SortOrder.LayoutOrder
					pbHeaderRowLayout.VerticalAlignment = Enum.VerticalAlignment.Center
					pbHeaderRowLayout.Parent = pbHeaderRow

					local pbName = Instance.new("TextLabel")
					pbName.Name = "ProgressbarName"
					pbName.FontFace = Font.new(assets.interFont, Settings.Bold and Enum.FontWeight.Bold or Enum.FontWeight.Medium, Enum.FontStyle.Normal)
					pbName.RichText = true
					pbName.Text = Settings.Name or ""
					setThemed(pbName, "TextColor3", "Text")
					pbName.TextSize = 13
					pbName.TextTransparency = 0.2
					pbName.TextXAlignment = Enum.TextXAlignment.Left
					pbName.AutomaticSize = Enum.AutomaticSize.XY
					pbName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					pbName.BackgroundTransparency = 1
					pbName.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbName.BorderSizePixel = 0
					pbName.LayoutOrder = 0
					pbName.Size = UDim2.fromScale(0, 0)
					pbName.Parent = pbHeaderRow

					local pbValueLabel = Instance.new("TextLabel")
					pbValueLabel.Name = "ProgressbarValueLabel"
					pbValueLabel.FontFace = Font.new(assets.interFont, Enum.FontWeight.Medium, Enum.FontStyle.Normal)
					pbValueLabel.RichText = true
					pbValueLabel.Text = tostring(math.round(currentValue)) .. "%"
					setThemed(pbValueLabel, "TextColor3", "Text")
					pbValueLabel.TextSize = 12
					pbValueLabel.TextTransparency = 0.5
					pbValueLabel.TextXAlignment = Enum.TextXAlignment.Right
					pbValueLabel.AutomaticSize = Enum.AutomaticSize.XY
					pbValueLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
					pbValueLabel.BackgroundTransparency = 1
					pbValueLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbValueLabel.BorderSizePixel = 0
					pbValueLabel.LayoutOrder = 1
					pbValueLabel.Size = UDim2.fromScale(1, 0)
					pbValueLabel.Parent = pbHeaderRow

					local pbTrack = Instance.new("Frame")
					pbTrack.Name = "ProgressbarTrack"
					setThemed(pbTrack, "BackgroundColor3", "Button")
					pbTrack.BackgroundTransparency = 0.7
					pbTrack.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbTrack.BorderSizePixel = 0
					pbTrack.LayoutOrder = 1
					pbTrack.Size = UDim2.new(1, 0, 0, 6)
					pbTrack.ClipsDescendants = true
					pbTrack.Parent = pbFrame

					local pbTrackUICorner = Instance.new("UICorner")
					pbTrackUICorner.Name = "ProgressbarTrackUICorner"
					pbTrackUICorner.CornerRadius = UDim.new(1, 0)
					pbTrackUICorner.Parent = pbTrack

					local pbTrackUIStroke = Instance.new("UIStroke")
					pbTrackUIStroke.Name = "ProgressbarTrackUIStroke"
					pbTrackUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
					setThemed(pbTrackUIStroke, "Color", "Outline")
					pbTrackUIStroke.Transparency = 0.9
					pbTrackUIStroke.Parent = pbTrack

					local pbFill = Instance.new("Frame")
					pbFill.Name = "ProgressbarFill"
					pbFill.BackgroundColor3 = currentColor
					pbFill.BorderColor3 = Color3.fromRGB(0, 0, 0)
					pbFill.BorderSizePixel = 0
					pbFill.Size = UDim2.fromScale(currentValue / 100, 1)
					pbFill.Parent = pbTrack

					local pbFillUICorner = Instance.new("UICorner")
					pbFillUICorner.Name = "ProgressbarFillUICorner"
					pbFillUICorner.CornerRadius = UDim.new(1, 0)
					pbFillUICorner.Parent = pbFill

					local function applyValue(val, skipTween)
						val = math.clamp(val, 0, 100)
						currentValue = val
						pbValueLabel.Text = tostring(math.round(val)) .. "%"
						local targetSize = UDim2.fromScale(val / 100, 1)
						if skipTween then
							pbFill.Size = targetSize
						else
							Tween(pbFill, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = targetSize }):Play()
						end
						ProgressbarFunctions.Value = val
					end

					applyValue(currentValue, true)

					function ProgressbarFunctions:SetValue(val)
						applyValue(val, false)
					end
					function ProgressbarFunctions:SetColor(color)
						currentColor = color
						pbFill.BackgroundColor3 = color
					end
					function ProgressbarFunctions:SetName(New)
						pbName.Text = New
					end
					function ProgressbarFunctions:SetVisibility(State)
						pbFrame.Visible = State
					end
					function ProgressbarFunctions:Destroy()
						pbFrame:Destroy()
					end

					if Flag then
						WMacLib.Options[Flag] = ProgressbarFunctions
					end
	...
	shared.__WMacLibWindow = WindowFunctions
...
function WMacLib:Demo()
	...
	local tabs = {
		...
		Settings = tabGroups.TabGroup1:Tab({ Name = "Config", Image = "lucide/sliders-horizontal" }),
	}
	...
	local DemoProgress = sections.MainSection2:Progressbar({
		Name = "Loading",
		Default = 0,
