...
function WMacLib:Gradient(text, fromColor, toColor)
	...
	for _, codepoint in utf8.codes(text) do
		...
		local r = math.round(fromColor.R * 255 + (toColor.R * 255 - fromColor.R * 255) * t)
		local g = math.round(fromColor.G * 255 + (toColor.G * 255 - fromColor.G * 255) * t)
		local b = math.round(fromColor.B * 255 + (toColor.B * 255 - fromColor.B * 255) * t)
	...
	task.spawn(function()
		...
		while not unloaded do
			for i = 1, #subtitleText do
				...
				Window:SetSubtitle(WMacLib:Gradient(subtitleText:sub(1, i), Color3.fromRGB(73, 230, 133), Color3.fromRGB(100, 150, 255)))
				task.wait(0.08)
			end
			task.wait(1.5)
