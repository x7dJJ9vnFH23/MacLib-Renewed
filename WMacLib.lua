...
toggleGui.DisplayOrder = 2147483646
...
-- Dragging for the toggle button
...
-- Hook into the existing minimize button to show the toggle btn
local base = Window  -- reference
...
-- Override minimize to also show toggle button
-- Find the minimize button and extend its behavior
local origSetState = Window.SetState
Window.SetState = function(self, state)
    origSetState(self, state)
    toggleBtn.Visible = not state
end
